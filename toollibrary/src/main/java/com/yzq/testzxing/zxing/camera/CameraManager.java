...
package com.yzq.testzxing.zxing.camera;
...
public final class CameraManager {
	...
	private static int MAX_FRAME_WIDTH = 480;//1200; // = 5/8 * 1920
	private static int MAX_FRAME_HEIGHT = 480;//675; // = 5/8 * 1080
...
//			int topOffset = (screenResolution.y - height) / 3;
			...
			int width = screenResolution.x * 3 / 4;//设定框框宽度大小
